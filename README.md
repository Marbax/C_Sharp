...
## HW
>- абстрактный класс товар - от него : бытовая химия и продукты (тоже абстракты),потом создать несколько конкретных классов каждого из типов   
>- потом интерфейсы (напр скоропортящиейся продукты (напр. класс молоко)) , классы реализуют интерфейсы   
>- если есть иерархия подвидов обьект,если связаны - это классы   
>- если одно свойство общее или метод - интерфейс  
>- напр. скоропорт - свойство даты и буль испортился или нет   
>- напр. бьющиеся - метод разбить и буль разбит или нет  
>- классы управления потоками - (напрю реализовано - массив товаров ) это 4 разных класса ,одно поле внутри - массив , два метода - добавитьб удалить
>- все в отдельные файлы,даже если малоо строчек  
>- собственные классы исключений можно не делать - т.к. не проходили 
